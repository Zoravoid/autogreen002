...
const MOISTURE_URL = `http://lilithvoid.local:80/backend/api/moisture/${deviceId}/moistures?page=${page}&size=${size}&sort=timeStamp,desc`;
...
> <CartesianGrid strokeDasharray="3 3" /> <XAxis dataKey="time_stamp" reversed={true}/> <YAxis width="auto" dataKey="moisture_val"/> <Tooltip /> <Legend />
